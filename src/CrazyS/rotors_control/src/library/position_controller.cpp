...
// void PositionController::calculatenewmessage(Eigen::Vector4d& ref_rotor_velocities) {
...
//    // topic. publish  control_t_.thrust
//    // and  theta_command and phi_command

   

//     AttitudeController(&p_command, &q_command, theta_command, phi_command);
//     YawPositionController(&r_command);
//     RateController(&delta_phi, &delta_theta, &delta_psi, p_command, q_command, r_command);
    
//     double PWM_1, PWM_2, PWM_3, PWM_4;
//     ControlMixer(control_t_.thrust, delta_phi, delta_theta, delta_psi, &PWM_1, &PWM_2, &PWM_3, &PWM_4);

//     CalculateRotorVelocities(&ref_rotor_velocities, PWM_1, PWM_2, PWM_3, PWM_4);
// }


void PositionController::ControlMixer(double thrust, double delta_phi, double delta_theta, double delta_psi, 
...
void PositionController::CalculateRotorVelocities(Eigen::Vector4d* rotor_velocities, double* PWM_1, double* PWM_2, double* PWM_3, double* PWM_4) {
...
void PositionController::RateController(double* delta_phi, double* delta_theta, double* delta_psi, double* p_command, double* q_command, double* r_command) {
...
void PositionController::AttitudeControllerFunction(double* p_command, double* q_command, double* theta_command, double* phi_command) {
...
void PositionController::SetCurrentStateFromOdometry(const EigenOdometry& odometry) {
